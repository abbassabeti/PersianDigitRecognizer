...
# print('X is',len(X_train),len(X_train[0]))
# print('Y is',len(Y_train),len(Y_train[0]))
# for i in X_train[0]:
#     print('X',i)
# print('Y',Y_train[0])
...
# coreml_model.author = 'Abbas Sabeti'
# coreml_model.license = 'AsanPardakht'
# coreml_model.short_description = 'Persian digit recognition'
# coreml_model.save('persian_digits.mlmodel')